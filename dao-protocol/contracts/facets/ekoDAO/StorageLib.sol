...
library StorageLib {
    ...
    event New_Proposal(address indexed author, Proposal indexed proposal, uint indexed Proposal_ID);
    event Add_Delegate(address indexed delegator, address indexed delegate, uint indexed Proposal_ID);
    event Remove_Delegate(address indexed delegator, address indexed delegate, uint indexed Proposal_ID);
    event Vote_For(address indexed Voter, uint Proposal_ID);
    event Vote_For_As_Delegate(address indexed delegator, address indexed voting_delegate, uint Proposal_ID);
    event Vote_Against(address indexed Voter, uint Proposal_ID);
    event Vote_Against_As_Delegate(address indexed delegator, address indexed voting_delegate, uint Proposal_ID);
